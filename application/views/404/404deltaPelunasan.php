...
<script type="text/javascript">
    ...
    if (jInit == 'awal') {
        ...
        texttitle = '404 Pelunasan Delta Rupiah - Tahun '+<?php echo date('Y')?>+'/'+<?php echo date('Y')-1?>+' (NASIONAL)';
        texttitle2 = '404 Pelunasan Delta Lembar - Tahun '+<?php echo date('Y')?>+'/'+<?php echo date('Y')-1?>+' (NASIONAL)';
    ...
    $(document).ready(function(){
        $("#bcari").click(function(){
            ...
            if (tahun == null || tahun == '') {
                ...
                $.ajax({
                    type: "post",
                    url: "<?php echo site_url('data_404/getdata404delta/lunasdelta') ?>",
                    cache: false,               
                    ...
                    success: function(data){
                        ...
                        if (status == 'Kosong') {
                            ...
                            if (junitupi != "" && junitap != "" && junitup != "") {
                                texttitle = '404 Pelunasan Delta Rupiah - Tahun '+jtahun+'/'+jtahun1+' ('+jnunitup+')'
                                texttitle2 = '404 Pelunasan Delta Lembar - Tahun '+jtahun+'/'+jtahun1+' ('+jnunitup+')'
                            } else if(junitupi != "" && junitap != ""){
                                texttitle = '404 Pelunasan Delta Rupiah - Tahun '+jtahun+'/'+jtahun1+' ('+jnunitap+')'
                                texttitle2 = '404 Pelunasan Delta Lembar - Tahun '+jtahun+'/'+jtahun1+' ('+jnunitap+')'
                            } else {
                                texttitle = '404 Pelunasan Delta Rupiah - Tahun '+jtahun+'/'+jtahun1+' ('+jnunitupi+')'
                                texttitle2 = '404 Pelunasan Delta Lembar - Tahun '+jtahun+'/'+jtahun1+' ('+jnunitupi+')'
                            }
