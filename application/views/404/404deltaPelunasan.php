...
<section class="content">
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-body">
                    <div id="inchart"><h2 style="text-align: center">404 Pelunasan Delta - Cari Data Terlebih Dahulu!</h2></div>
                    ...
                    success: function(data){
                        ...
                        if (status == 'Kosong') {
                            ...
                            if (junitupi != "" && junitap != "" && junitup != "") {
                                texttitle = '404 Pelunasan Delta Rupiah - Tahun '+tahun+'/'+tahun1+' ('+junitup+')'
                                texttitle2 = '404 Pelunasan Delta Lembar - Tahun '+tahun+'/'+tahun1+' ('+junitup+')'
                            } else if(junitupi != "" && junitap != ""){
                                texttitle = '404 Pelunasan Delta Rupiah - Tahun '+tahun+'/'+tahun1+' ('+junitap+')'
                                texttitle2 = '404 Pelunasan Delta Lembar - Tahun '+tahun+'/'+tahun1+' ('+junitap+')'
                            } else {
                                texttitle = '404 Pelunasan Delta Rupiah - Tahun '+tahun+'/'+tahun1+' ('+junitupi+')'
                                texttitle2 = '404 Pelunasan Delta Lembar - Tahun '+tahun+'/'+tahun1+' ('+junitupi+')'
                            }
