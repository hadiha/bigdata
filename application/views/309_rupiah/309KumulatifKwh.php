...
var texttitle = '';
if (jInit == 'awal') {
    texttitle = '309 Kwh Komulatif Gabungan - Tahun '+<?php echo date('Y')?>+' (NASIONAL)';
            ...
            success: function(data){
                ...
                if (status == 'Kosong') {
                    ...
                    if (junitupi != "" && junitap != "" && junitup != "") {
                        texttitle = '309 Kwh Komulatif'+jenislap+' - Tahun '+jtahun+' ('+junitup+')'
                    } else if(junitupi != "" && junitap != ""){
                        texttitle = '309 Kwh Komulatif'+jenislap+' - Tahun '+jtahun+' ('+junitap+')'
                    } else {
                        texttitle = '309 Kwh Komulatif '+jenislap+' - Tahun '+jtahun+' ('+junitupi+')'
                    }
