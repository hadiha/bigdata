...
var dataY = [{
    ticks: {
        callback: function(label, index, labels) {
            <?php if (!empty($unitap) or !empty($unitup)): ?>
...
var texttitle = <?php if (!empty($unitupi) && !empty($unitap) && !empty($unitup)): ?>
                    '309 Kwh Komulatif <?php echo $jenislap ?> - <?php echo $unitup ?> Tahun <?php echo $tahun ?>'
                <?php elseif (!empty($unitupi) && !empty($unitap)): ?>
                    '309 Kwh Komulatif <?php echo $jenislap ?> - <?php echo $unitap ?> Tahun <?php echo $tahun ?>'
                <?php else: ?>
                    '309 Kwh Komulatif <?php echo $jenislap ?> - <?php echo $unitupi ?> Tahun <?php echo $tahun ?>'
                <?php endif ?>
