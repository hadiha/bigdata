                ...
                success: function(data){
                    ...
                    if (status == 'Kosong') {
                        ...
                        if (junitupi != "" && junitap != "" && junitup != "") {
                            texttitle = '309 Rupiah Delta '+jenislap+' - Tahun '+jtahun+'/'+jtahun1+' ('+junitup+')'
                        } else if(junitupi != "" && junitap != ""){
                            texttitle = '309 Rupiah Delta '+jenislap+' - Tahun '+jtahun+'/'+jtahun1+' ('+junitap+')'
                        } else {
                            texttitle = '309 Rupiah Delta '+jenislap+' - Tahun '+jtahun+'/'+jtahun1+' ('+junitupi+')'
                        }
