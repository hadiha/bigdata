...
<div class="row">
                        ...
                        <div class="row">
                          ...
                          <div class="row">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <select name="tahun" id="tahun" class="form-control" required="true">
                                            ...
                                            <?php foreach ($rs_tahun as $index => $dtahun) { ?>
                                                        <option value="<?php echo $dtahun; ?>" <?php if ($search['tahun'] == $dtahun) {
                                            echo " selected";
                                        } ?>><?php echo $dtahun; ?></option>   
                                                    <?php } ?>
                                                </select>
                                        </select>
                                    </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <button class="btn btn-primary" id="bcari"  name="button" value="cari" onclick="bcari"><i class="fa fa-search fa-fw"></i> Cari</button>
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-body">
                    <div id="inchart"><h2 style="text-align: center">309 Rupiah ALL - Cari Data Terlebih Dahulu!</h2></div>
...
if(jInit == 'akhir'){
    ...
    texttitle = <?php if (!empty($unitupi) && !empty($unitap) && !empty($unitup)): ?>
                    '309 Rupiah <?php echo $jenislap ?> - Tahun <?php echo $tahun ?> (<?php echo $unitup ?>)'
                <?php elseif (!empty($unitupi) && !empty($unitap)): ?>
                    '309 Rupiah <?php echo $jenislap ?> - Tahun <?php echo $tahun ?> (<?php echo $unitap ?>)'
                <?php else: ?>
                    '309 Rupiah <?php echo $jenislap ?> - Tahun <?php echo $tahun ?> (<?php echo $unitupi ?>)'
                <?php endif ?>
}
