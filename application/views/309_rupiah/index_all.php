...
var texttitle = '';
if (jInit == 'awal') {
    texttitle = '309 Rupiah Gabungan - Tahun '+<?php echo date('Y')?>+' (NASIONAL)';
            ...
            success: function(data){
                ...
                if (status == 'Kosong') {
                    ...
                    if (junitupi != "" && junitap != "" && junitup != "") {
                        texttitle = '309 Rupiah '+jjenislap+' - Tahun '+jtahun+' ('+jnunitup+')'
                    } else if(junitupi != "" && junitap != ""){
                        texttitle = '309 Rupiah '+jjenislap+' - Tahun '+jtahun+' ('+jnunitap+')'
                    } else {
                        texttitle = '309 Rupiah '+jjenislap+' - Tahun '+jtahun+' ('+jnunitupi+')'
                    }
                    ...
                    renderchart();
                    // console.log(junitupi+' '+junitap+' '+junitup);
                }   
            }   
