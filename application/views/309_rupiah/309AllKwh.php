...
var texttitle = <?php if (!empty($unitupi) && !empty($unitap) && !empty($unitup)): ?>
                    '309 Kwh <?php echo $jenislap ?> - <?php echo $unitup ?> Tahun <?php echo $tahun ?>'
                <?php elseif (!empty($unitupi) && !empty($unitap)): ?>
                    '309 Kwh <?php echo $jenislap ?> - <?php echo $unitap ?> Tahun <?php echo $tahun ?>'
                <?php else: ?>
                    '309 Kwh <?php echo $jenislap ?> - <?php echo $unitupi ?> Tahun <?php echo $tahun ?>'
                <?php endif ?>
...
function cari(){
    ...
    $('#form_filter').ajaxForm ({
        type: "POST",
        url: "<?php echo base_url('Rupiah_309/data309/allkwh'); ?>",
